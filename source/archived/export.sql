...
--------------------------------------------------------
  ...
  CREATE TABLE "BME_ATE_STN" 
   ...
   COMMENT ON TABLE "BME_ATE_STN"  IS 'athlete subscriptions';
--------------------------------------------------------
--  DDL for Table BME_ATHLETES
--------------------------------------------------------

  CREATE TABLE "BME_ATHLETES" 
   (	"ID" NUMBER, 
   ...
   COMMENT ON TABLE "BME_ATHLETES"  IS 'table alias = ate';
--------------------------------------------------------
--  DDL for Table BME_BOXES
--------------------------------------------------------

  CREATE TABLE "BME_BOXES" 
   (	"ID" NUMBER, 
   ...
   COMMENT ON TABLE "BME_BOXES"  IS 'table alias = box';
--------------------------------------------------------
--  DDL for Table BME_PAYMENTS
--------------------------------------------------------

  CREATE TABLE "BME_PAYMENTS" 
   (	"ID" NUMBER, 
	"ATE_ID" NUMBER, 
	"STN_ID" NUMBER, 
	"DATE_TIME" DATE, 
   ...
   COMMENT ON COLUMN "BME_PAYMENTS"."TYPE" IS 'Payment type, eg: subscription fee';
   COMMENT ON TABLE "BME_PAYMENTS"  IS 'alias = pmt, a next payment should automatically be created';
--------------------------------------------------------
--  DDL for Table BME_SIGNINS
--------------------------------------------------------

  CREATE TABLE "BME_SIGNINS" 
   (	"ID" NUMBER, 
	"ATE_ID" NUMBER, 
	"WKT_ID" NUMBER, 
	"DATE_TIME" DATE, 
   ...
   COMMENT ON TABLE "BME_SIGNINS"  IS 'alias = sin';
--------------------------------------------------------
--  DDL for Table BME_SUBSCRIPTIONS
--------------------------------------------------------

  CREATE TABLE "BME_SUBSCRIPTIONS" 
   (	"ID" NUMBER, 
	"BOX_ID" NUMBER, 
	"NAME" VARCHAR2(255 BYTE) , 
   ...
   COMMENT ON COLUMN "BME_SUBSCRIPTIONS"."SIN_ALLOWED_D" IS 'daily allowed sign ins';
   COMMENT ON COLUMN "BME_SUBSCRIPTIONS"."SIN_ALLOWED_W" IS 'weekly allowed sign ins';
   COMMENT ON COLUMN "BME_SUBSCRIPTIONS"."SIN_ALLOWED_M" IS 'monthly allowed sign ins';
   COMMENT ON COLUMN "BME_SUBSCRIPTIONS"."PAYMENT_PERIOD" IS 'when should athlete pay? d is used for one time only payments';
   COMMENT ON TABLE "BME_SUBSCRIPTIONS"  IS 'table alias = stn';
--------------------------------------------------------
--  DDL for Table BME_WORKOUTS
--------------------------------------------------------

  CREATE TABLE "BME_WORKOUTS" 
   (	"ID" NUMBER, 
   ...
   COMMENT ON COLUMN "BME_WORKOUTS"."THE_GROUP" IS 'eg: crossfit, weight lifting, yoga';
   COMMENT ON COLUMN "BME_WORKOUTS"."TYPE1" IS 'eg: warmup, cooldown, WOD';
   COMMENT ON TABLE "BME_WORKOUTS"  IS 'workouts, alias = wkt';
REM INSERTING into BME_ATE_STN
SET DEFINE OFF;
Insert into BME_ATE_STN (ID,ATE_ID,STN_ID,START_DATE,END_DATE,CREATED,CREATED_BY,UPDATED,UPDATED_BY) values (207277441012904293735395733428831756818,207277441012903084809576118799657050642,207282496691576609700455129829808770289,to_date('12-JAN-20','DD-MON-RR'),null,to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN');
Insert into BME_ATE_STN (ID,ATE_ID,STN_ID,START_DATE,END_DATE,CREATED,CREATED_BY,UPDATED,UPDATED_BY) values (207277441012907920512854577316355875346,207277441012906711587034962687181169170,207282496691577818626274744458983476465,to_date('01-JAN-20','DD-MON-RR'),null,to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN');
Insert into BME_ATE_STN (ID,ATE_ID,STN_ID,START_DATE,END_DATE,CREATED,CREATED_BY,UPDATED,UPDATED_BY) values (207277441012910338364493806574705287698,207277441012909129438674191945530581522,207282496691577818626274744458983476465,to_date('01-JAN-20','DD-MON-RR'),null,to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN');
Insert into BME_ATE_STN (ID,ATE_ID,STN_ID,START_DATE,END_DATE,CREATED,CREATED_BY,UPDATED,UPDATED_BY) values (207277441012912756216133035833054700050,207277441012911547290313421203879993874,207282496691579027552094359088158182641,to_date('01-NOV-19','DD-MON-RR'),null,to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN');
Insert into BME_ATE_STN (ID,ATE_ID,STN_ID,START_DATE,END_DATE,CREATED,CREATED_BY,UPDATED,UPDATED_BY) values (198736110877782411940201727282765695802,198589733089231148943268571854463398512,198589733089226313239990113337764573808,to_date('01-OCT-19','DD-MON-RR'),null,to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('22-OCT-19','DD-MON-RR'),'ADMIN');
Insert into BME_ATE_STN (ID,ATE_ID,STN_ID,START_DATE,END_DATE,CREATED,CREATED_BY,UPDATED,UPDATED_BY) values (207282496691582654329553202975682301169,207277441012901875883756504170482344466,207282496691576609700455129829808770289,to_date('12-JAN-20','DD-MON-RR'),null,to_date('12-JAN-20','DD-MON-RR'),'BME',to_date('12-JAN-20','DD-MON-RR'),'BME');
REM INSERTING into BME_ATHLETES
SET DEFINE OFF;
Insert into BME_ATHLETES (ID,FIRST_NAME,LAST_NAME,PHONE1,PHONE2,EMAIL,DATE_OF_BIRTH,CREATED,CREATED_BY,UPDATED,UPDATED_BY,GENDER,USERNAME,PASSWORD) values (207277441012901875883756504170482344466,'Mathew','Fraser',null,null,null,to_date('25-JAN-90','DD-MON-RR'),to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN',null,null,null);
...
REM INSERTING into BME_BOXES
SET DEFINE OFF;
Insert into BME_BOXES (ID,NAME,CREATED,CREATED_BY,UPDATED,UPDATED_BY,CODE) values (207277441012900666957936889541307638290,'Demo Box',to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN','DBX');
Insert into BME_BOXES (ID,NAME,CREATED,CREATED_BY,UPDATED,UPDATED_BY,CODE) values (198589733089223895388350884079415161456,'Crossfit Longclaw',to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'BME','CFLC');
REM INSERTING into BME_PAYMENTS
SET DEFINE OFF;
Insert into BME_PAYMENTS (ID,ATE_ID,STN_ID,DATE_TIME,AMOUNT,RECEIVED_BY,RECEIPT_NR,CREATED,CREATED_BY,UPDATED,UPDATED_BY,TYPE,DESCRIPTION) values (207277441012917591919411494349753524754,207277441012911547290313421203879993874,207282496691579027552094359088158182641,to_date('01-JAN-20','DD-MON-RR'),500,null,null,to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN','SUBSCRIPTION FEE',null);
REM INSERTING into BME_SIGNINS
SET DEFINE OFF;
REM INSERTING into BME_SUBSCRIPTIONS
SET DEFINE OFF;
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (198589733089225104314170498708589867632,198589733089223895388350884079415161456,'Unlimited workouts, SRD 350 monthly',null,null,600,350,'M',to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('24-OCT-19','DD-MON-RR'),'BME','M');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (198589733089226313239990113337764573808,198589733089223895388350884079415161456,'3 Workouts a week, SRD 275 monthly',null,3,null,275,'M',to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('24-OCT-19','DD-MON-RR'),'BME','W');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (198589733089227522165809727966939279984,198589733089223895388350884079415161456,'2 Workouts a week, 200 SRD monthly',null,2,null,200,'M',to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('24-OCT-19','DD-MON-RR'),'BME','W');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (198589733089228731091629342596113986160,198589733089223895388350884079415161456,'Drop-in',1,null,null,50,'D',to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('24-OCT-19','DD-MON-RR'),'BME','D');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (198589733089229940017448957225288692336,198589733089223895388350884079415161456,'6 Workouts card, valid for 1 week SRD 225',null,6,null,225,'D',to_date('22-OCT-19','DD-MON-RR'),'ADMIN',to_date('24-OCT-19','DD-MON-RR'),'BME','W');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (207282496691576609700455129829808770289,207277441012900666957936889541307638290,'Unlimited workouts, $ 350 monthly',null,null,600,350,'M',to_date('12-JAN-20','DD-MON-RR'),'BME',to_date('12-JAN-20','DD-MON-RR'),'ADMIN','M');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (207282496691577818626274744458983476465,207277441012900666957936889541307638290,'3 Workouts a week, $275 monthly',null,3,null,275,'M',to_date('12-JAN-20','DD-MON-RR'),'BME',to_date('12-JAN-20','DD-MON-RR'),'ADMIN','W');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (207282496691579027552094359088158182641,207277441012900666957936889541307638290,'2 Workouts a week, 200 $monthly',null,2,null,200,'M',to_date('12-JAN-20','DD-MON-RR'),'BME',to_date('12-JAN-20','DD-MON-RR'),'ADMIN','W');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (207282496691580236477913973717332888817,207277441012900666957936889541307638290,'Drop-in',1,null,null,50,'D',to_date('12-JAN-20','DD-MON-RR'),'BME',to_date('12-JAN-20','DD-MON-RR'),'BME','D');
Insert into BME_SUBSCRIPTIONS (ID,BOX_ID,NAME,SIN_ALLOWED_D,SIN_ALLOWED_W,SIN_ALLOWED_M,PRICE,PAYMENT_PERIOD,CREATED,CREATED_BY,UPDATED,UPDATED_BY,SIN_COUNT_PERIOD) values (207282496691581445403733588346507594993,207277441012900666957936889541307638290,'6 Workouts card, valid for 1 week $225',null,6,null,225,'D',to_date('12-JAN-20','DD-MON-RR'),'BME',to_date('12-JAN-20','DD-MON-RR'),'ADMIN','W');
REM INSERTING into BME_WORKOUTS
SET DEFINE OFF;
Insert into BME_WORKOUTS (ID,THE_GROUP,DATETIME_START,DATETIME_END,NAME1,TYPE1,DESCRIPTION1,NAME2,TYPE2,DESCRIPTION2,NAME3,TYPE3,DESCRIPTION3,NAME4,TYPE4,DESCRIPTION4,NAME5,TYPE5,DESCRIPTION5,CREATED,CREATED_BY,UPDATED,UPDATED_BY,BOX_ID) values (207277441012913965141952650462229406226,'CF',to_date('12-JAN-20','DD-MON-RR'),to_date('12-JAN-20','DD-MON-RR'),'Warm up','Warm Up','Jumping Jacks till you drop.',null,null,null,null,null,null,null,null,null,null,null,null,to_date('12-JAN-20','DD-MON-RR'),'ADMIN',to_date('12-JAN-20','DD-MON-RR'),'ADMIN',207277441012900666957936889541307638290);
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BME_ATHLETES_ID_PK" ON "BME_ATHLETES" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_PAYMENTS_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BME_PAYMENTS_ID_PK" ON "BME_PAYMENTS" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_ATE_STN_I2
--------------------------------------------------------

  CREATE INDEX "BME_ATE_STN_I2" ON "BME_ATE_STN" ("STN_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_SIGNINS_I3
--------------------------------------------------------

  CREATE INDEX "BME_SIGNINS_I3" ON "BME_SIGNINS" ("WKT_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_ATE_STN_I1
--------------------------------------------------------

  CREATE INDEX "BME_ATE_STN_I1" ON "BME_ATE_STN" ("ATE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_SIGNINS_I2
--------------------------------------------------------

  CREATE INDEX "BME_SIGNINS_I2" ON "BME_SIGNINS" ("PREV_SIN_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_WORKOUTS_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BME_WORKOUTS_ID_PK" ON "BME_WORKOUTS" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_ATE_STN_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BME_ATE_STN_ID_PK" ON "BME_ATE_STN" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_SIGNINS_I1
--------------------------------------------------------

  CREATE INDEX "BME_SIGNINS_I1" ON "BME_SIGNINS" ("ATE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_SUBSCRIPTIONS_I1
--------------------------------------------------------

  CREATE INDEX "BME_SUBSCRIPTIONS_I1" ON "BME_SUBSCRIPTIONS" ("BOX_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_SIGNINS_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BME_SIGNINS_ID_PK" ON "BME_SIGNINS" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_PAYMENTS_I3
--------------------------------------------------------

  CREATE INDEX "BME_PAYMENTS_I3" ON "BME_PAYMENTS" ("STN_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_BOXES_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BME_BOXES_ID_PK" ON "BME_BOXES" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_PAYMENTS_I1
--------------------------------------------------------

  CREATE INDEX "BME_PAYMENTS_I1" ON "BME_PAYMENTS" ("ATE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index BME_SUBSCRIPTIONS_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BME_SUBSCRIPTIONS_ID_PK" ON "BME_SUBSCRIPTIONS" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Trigger BME_ATE_STN_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_ATE_STN_BIU" 
...
/
ALTER TRIGGER "BME_ATE_STN_BIU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BME_ATHLETES_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_ATHLETES_BIU" 
    before insert or update  
    on bme_athletes 
    for each row 
begin 
...
/
ALTER TRIGGER "BME_ATHLETES_BIU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BME_BOXES_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_BOXES_BIU" 
    before insert or update  
    on bme_boxes 
    for each row 
begin 
...
/
ALTER TRIGGER "BME_BOXES_BIU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BME_PAYMENTS_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_PAYMENTS_BIU" 
    before insert or update  
    on bme_payments 
    for each row 
begin 
...
/
ALTER TRIGGER "BME_PAYMENTS_BIU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BME_SIGNINS_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_SIGNINS_BIU" 
    before insert or update  
    on bme_signins 
    for each row 
begin 
...
/
ALTER TRIGGER "BME_SIGNINS_BIU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BME_SUBSCRIPTIONS_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_SUBSCRIPTIONS_BIU" 
    before insert or update  
...
/
ALTER TRIGGER "BME_SUBSCRIPTIONS_BIU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BME_WORKOUTS_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BME_WORKOUTS_BIU" 
    before insert or update  
    on bme_workouts 
    for each row 
begin 
...
/
ALTER TRIGGER "BME_WORKOUTS_BIU" ENABLE;
--------------------------------------------------------
--  Constraints for Table BME_ATHLETES
--------------------------------------------------------

  ALTER TABLE "BME_ATHLETES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_ATHLETES" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_ATHLETES" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_ATHLETES" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_ATHLETES" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_ATHLETES" ADD CONSTRAINT "BME_ATHLETES_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table BME_PAYMENTS
--------------------------------------------------------

  ALTER TABLE "BME_PAYMENTS" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("ATE_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("STN_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("DATE_TIME" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("AMOUNT" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_PAYMENTS" ADD CONSTRAINT "BME_PAYMENTS_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table BME_SUBSCRIPTIONS
--------------------------------------------------------

  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("BOX_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("SIN_COUNT_PERIOD" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" ADD CONSTRAINT "BME_STN_CHK2" CHECK (sin_count_period in ('D','M','W')) ENABLE;
  ALTER TABLE "BME_SUBSCRIPTIONS" ADD CONSTRAINT "BME_STN_CHK3" CHECK ((sin_allowed_d is not null and sin_count_period = 'D') or 
(sin_allowed_w is not null and sin_count_period = 'W') or 
(sin_allowed_m is not null and sin_count_period = 'M')) ENABLE;
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("PRICE" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("PAYMENT_PERIOD" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_SUBSCRIPTIONS" ADD CONSTRAINT "BME_STN_CHK1" CHECK (payment_period in ('D','W','M')) ENABLE;
  ALTER TABLE "BME_SUBSCRIPTIONS" ADD CONSTRAINT "BME_SUBSCRIPTIONS_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table BME_BOXES
--------------------------------------------------------

  ALTER TABLE "BME_BOXES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_BOXES" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_BOXES" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_BOXES" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_BOXES" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_BOXES" ADD CONSTRAINT "BME_BOXES_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
  ALTER TABLE "BME_BOXES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "BME_BOXES" MODIFY ("CODE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table BME_WORKOUTS
--------------------------------------------------------

  ALTER TABLE "BME_WORKOUTS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("THE_GROUP" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("DATETIME_START" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("DATETIME_END" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("NAME1" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("TYPE1" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("DESCRIPTION1" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_WORKOUTS" ADD CONSTRAINT "BME_WORKOUTS_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
  ALTER TABLE "BME_WORKOUTS" MODIFY ("BOX_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table BME_SIGNINS
--------------------------------------------------------

  ALTER TABLE "BME_SIGNINS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" MODIFY ("ATE_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" MODIFY ("WKT_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_SIGNINS" ADD CONSTRAINT "BME_SIGNINS_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table BME_ATE_STN
--------------------------------------------------------

  ALTER TABLE "BME_ATE_STN" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("ATE_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("STN_ID" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("START_DATE" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("UPDATED" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BME_ATE_STN" ADD CONSTRAINT "BME_ATE_STN_ID_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BME_ATE_STN
--------------------------------------------------------

  ALTER TABLE "BME_ATE_STN" ADD CONSTRAINT "BME_ATE_STN_ATE_ID_FK" FOREIGN KEY ("ATE_ID")
	  REFERENCES "BME_ATHLETES" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "BME_ATE_STN" ADD CONSTRAINT "BME_ATE_STN_STN_ID_FK" FOREIGN KEY ("STN_ID")
	  REFERENCES "BME_SUBSCRIPTIONS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BME_PAYMENTS
--------------------------------------------------------

  ALTER TABLE "BME_PAYMENTS" ADD CONSTRAINT "BME_PAYMENTS_ATE_ID_FK" FOREIGN KEY ("ATE_ID")
	  REFERENCES "BME_ATHLETES" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "BME_PAYMENTS" ADD CONSTRAINT "BME_PAYMENTS_STN_ID_FK" FOREIGN KEY ("STN_ID")
	  REFERENCES "BME_SUBSCRIPTIONS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BME_SIGNINS
--------------------------------------------------------

  ALTER TABLE "BME_SIGNINS" ADD CONSTRAINT "BME_SIGNINS_ATE_ID_FK" FOREIGN KEY ("ATE_ID")
	  REFERENCES "BME_ATHLETES" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "BME_SIGNINS" ADD CONSTRAINT "BME_SIGNINS_WKT_ID_FK" FOREIGN KEY ("WKT_ID")
	  REFERENCES "BME_WORKOUTS" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "BME_SIGNINS" ADD CONSTRAINT "BME_SIGNINS_PREV_SIN_ID_FK" FOREIGN KEY ("PREV_SIN_ID")
	  REFERENCES "BME_SIGNINS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BME_SUBSCRIPTIONS
--------------------------------------------------------

  ALTER TABLE "BME_SUBSCRIPTIONS" ADD CONSTRAINT "BME_SUBSCRIPTIONS_BOX_ID_FK" FOREIGN KEY ("BOX_ID")
	  REFERENCES "BME_BOXES" ("ID") ON DELETE CASCADE ENABLE;
